<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportBill_Print.aspx.cs" Inherits="Admin_ImportBill_Print" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Xem hóa đơn nhập</title>
    <style type="text/css">
        .style1
        {
            width: 99%;
    ...
    <div class="common"><table class="style1">
        <tr>
            <td class="style7">
                Người nhập:</td>
            <td>
                <asp:Label ID="lbImporter" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style7">
