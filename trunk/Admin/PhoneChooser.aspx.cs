...
public partial class Admin_PhoneChooser : System.Web.UI.Page
{
    ...
    {
        DataTable dPhone = Phone.GetAllWithKeyword(tKeyword.Text);

        if (sortExp != "")
        {
            dPhone.DefaultView.Sort = sortExp;
        }
        gShow.DataSource = dPhone;
        gShow.DataBind();
    }
