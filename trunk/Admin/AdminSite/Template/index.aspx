<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="Admin_AdminSite_Template_Default" %>
...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li><a href="list.html">Điện Thoại<!--[if IE 7]><!--></a><!--<![endif]-->
                    ...
                    <li><a href="login.html">Phụ Kiện<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                    ...
                    <li><a href="login.html">Nhà Phân Phối<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="http://localhost:1208/ASP.NET/Admin/DistributorManager.aspx" title="">level 1</a></li>
                        <li><a href="" title="">level 2</a></li>
                        <li><a href="" title="">level 3</a></li>
                        <li><a class="sub1" href="" title="">level 4<!--[if IE 7]><!--></a><!--<![endif]-->
                        <!--[if lte IE 6]><table><tr><td><![endif]-->
                            <ul>
                                <li><a href="" title="">level 4-1</a></li>
                                <li><a href="" title="">level 4-2</a></li>
                                <li><a class="sub2" href="#nogo">level 4-3<!--[if IE 7]><!--></a><!--<![endif]-->
                        
                                <!--[if lte IE 6]><table><tr><td><![endif]-->
                                    <ul>
                                        <li><a href="#nogo">level 4-3-1</a></li>
                                        <li><a href="#nogo">level 4-3-2</a></li>
                                        <li><a href="#nogo">level 4-3-3</a></li>
                                        <li><a href="#nogo">level 4-3-4</a></li>
                                    </ul>
                        ...
                        <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                         ...
                         <li><a href="" title="">level 5</a></li>
                        </ul>
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    </li>
                    <li><a href="login.html">Users<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
